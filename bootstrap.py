...
parser.add_option("--version", action="store_true", default=False, help=("Return bootstrap.py version."))
parser.add_option(
    "-t",
...
parser.add_option("--setuptools-to-dir", help=("Allow for re-use of existing directory of " "setuptools versions"))
...
cmd = [
    sys.executable,
    "-c",
    "import sys; sys.path[0:0] = [%r]; " % setuptools_path + "from setuptools.command.easy_install import main; main()",
    "-mZqNxd",
    tmpeggs,
]
